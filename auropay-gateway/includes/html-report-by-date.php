 ...
 * @return array
 */
function prepareChartData($data, $data_key, $interval, $start_date, $group_by)
{
    $prepared_data = array();
...
$ChartDataArr = array(
    'sale_amount'        => prepareChartData($allChartData, 'sale_amount', $interval, $start_date, $chart_groupby),
    'refund_amount'       => prepareChartData($allChartData, 'refund_amount', $interval, $start_date, $chart_groupby),
    'failed_amount' => prepareChartData($allChartData, 'failed_amount', $interval, $start_date, $chart_groupby),
);
