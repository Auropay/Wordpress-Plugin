...
require AUROPAY_PLUGIN_PATH . '/includes/html-report-by-date.php';
?>
            ...
            <div class="wrap">
                ...
                <div class="woocommerce-section-header ">
                        ...
                        <div class="postbox pt-bx-dtl">
                            ...
                            <div class="pymnt-hdr">
                                <div class="leftbox-sales" id="sale_box">
                                    <img class="pymnt-ico" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/summary/calculator_color.png" id="sale_img" />
                                    <div class="pymnt-ico-label">
                                        <div class="pymnt-label">
                                            <b> Sales</b>
                                        </div>
                                        <div class="pymnt-amt clr-grn">
                                            <b><span>$</span><?php echo $tot_payments ?></span></b>
                                        </div>
                                    </div>
                                </div>
                                <div class="middlebox-refund" id="refunded_box">
                                    <img class="pymnt-ico" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/summary/calendar_refund_color.png" id="refunded_img" />
                                    <div class="pymnt-ico-label">
                                        <div class="pymnt-label">
                                            <b>Refund</b>
                                        </div>
                                        <div class="pymnt-amt clr-orng">
                                            <b><span><b><span>$</span><?php echo $tot_refunded ?></span></b></span></b>
                                        </div>
                                    </div>
                                </div>
                                <div class="rightbox-failed" id="failed_box">
                                    <img class="pymnt-ico" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/summary/calendar_decline_color.png" id="failed_img" />
                                    <div class="pymnt-ico-label">
                                        <div class="pymnt-label">
                                            <b>Failed</b>
                                        </div>
                                        <div class="pymnt-amt clr-rd">
                                            <b><span>$</span><?php echo $tot_failed ?></span></b>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="sls-row" id="summary_main_box_type">
                                    ...
                                    <div class="card-label" id="sales_stat_details">
                                        <img class="ico-crd" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-card.png" /> <span><b>Credit Card </b> <?php echo $all_order_data['sale_tot_credit_card_payments']; ?> &nbsp;&nbsp;</span>
                                        <img class="ico-crd" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-card.png" /> <span><b>Debit Card </b><?php echo $all_order_data['sale_tot_debit_card_payments']; ?> &nbsp;&nbsp;</span>
                                        <img class="ico-nb" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-ach.png" /> <span><b>Net Banking </b><?php echo $all_order_data['sale_tot_netbanking_payments']; ?></span>
                                        <img class="ico-upi" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-upi.png" /> <span><b>UPI </b><?php echo $all_order_data['sale_tot_upi_payments']; ?></span>
                                        <img class="ico-upi" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-wallet.png" /> <span><b>Wallet </b><?php echo $all_order_data['sale_tot_wallet_payments']; ?></span>
                                    </div>

                                    <div class="card-label" id="refunded-stat-details">
                                        <img class="ico-crd" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-card.png" /> <span><b>Credit Card </b> <?php echo $all_order_data['refunded_tot_credit_card_payments']; ?> &nbsp;&nbsp;</span>
                                        <img class="ico-crd" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-card.png" /> <span><b>Debit Card </b><?php echo $all_order_data['refunded_tot_debit_card_payments']; ?> &nbsp;&nbsp;</span>
                                        <img class="ico-nb" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-ach.png" /> <span><b>Net Banking </b><?php echo $all_order_data['refunded_tot_netbanking_payments']; ?></span>
                                        <img class="ico-upi" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-upi.png" /> <span><b>UPI </b><?php echo $all_order_data['refunded_tot_upi_payments']; ?></span>
                                        <img class="ico-upi" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-wallet.png" /> <span><b>Wallet </b><?php echo $all_order_data['refunded_tot_wallet_payments']; ?></span>
                                    </div>

                                    <div class="card-label" id="failed-stat-details">
                                        <img class="ico-crd" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-card.png" /> <span><b>Credit Card </b> <?php echo $all_order_data['failed_tot_credit_card_payments']; ?> &nbsp;&nbsp;</span>
                                        <img class="ico-crd" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-card.png" /> <span><b>Debit Card </b><?php echo $all_order_data['failed_tot_debit_card_payments']; ?> &nbsp;&nbsp;</span>
                                        <img class="ico-nb" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-ach.png" /> <span><b>Net Banking </b><?php echo $all_order_data['failed_tot_netbanking_payments']; ?></span>
                                        <img class="ico-upi" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-upi.png" /> <span><b>UPI </b><?php echo $all_order_data['failed_tot_upi_payments']; ?></span>
                                        <img class="ico-upi" src="<?php echo AUROPAY_PLUGIN_URL ?>/assets/images/cards/ico-wallet.png" /> <span><b>Wallet </b><?php echo $all_order_data['failed_tot_wallet_payments']; ?></span>
                                    </div>
                                </div>
                    ...
                    <div class="trans-dtl-tbl">
                        ...
                        <ul class="subsubsub">
                            <li class="all"><a href="?page=payment-overview&orderby=post_id&order=desc&transaction_status=all&<?php echo $range_filter ?>">All <span class="count">(<?php echo $all_order_data['total_all_records']; ?>)</span></a> |</li>
                            <li><a href="?page=payment-overview&orderby=post_id&order=desc&transaction_status=completed&<?php echo $range_filter ?>">Sales <span class="count">(<?php echo $all_order_data['total_completed_records']; ?>)</span></a> |</li>
                            <li><a href="?page=payment-overview&orderby=post_id&order=desc&transaction_status=refund&<?php echo $range_filter ?>">Refunded <span class="count">(<?php echo $all_order_data['total_refund_records']; ?>)</span></a> |</li>
                            <li><a href="?page=payment-overview&orderby=post_id&order=desc&transaction_status=failed&<?php echo $range_filter ?>">Failed <span class="count">(<?php echo $all_order_data['total_failed_records']; ?>)</span></a></li>
                        </ul>
                            ...
                            <table class="wp-list-table widefat fixed striped w-auto table-view-list posts ">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" id="order_date" class="manage-column column-order_number   c_order_date column-primary2 sortable">Date & Time (IST)</th>
                                        <th scope="col" id="order_status" class="manage-column column-order_status  c_order_status sortable">Status</th>
                                        <th scope="col" id="order_total" class="manage-column column-order_status c_order_total column-primary3 sortable">Sale</th>
                                        <th scope="col" id="refund_total" class="manage-column column-order_status c_order_total column-primary3 sortable">Refund</th>
                                    ...
                                    if (!empty($all_order_data['order_datas'])) {
                                        foreach ($all_order_data['order_datas'] as $order_id) {
                                            ...
                                            if (strtolower($order_status) == 'success') {
                                                $status_color_code = 'success';
                                            } else if (strtolower($order_status) == 'failed') {
                                                $status_color_code = 'failed';
                                            } else {
                                                $status_color_code = 'refund';
                                            }
                                            ?>
                                            <tr id="post-<?php echo $order_id ?>" class="iedit author-self level-0 post-146 type-shop_order post-password-required hentry">
                                                <td id="row_order_number" class="order_number column-order_number c_order_number has-row-actions column-primary1"><a href="?page=refund-overview&order_id=<?php echo $order_id ?>"><strong>#<?php echo $order_id ?> </strong></a></td>
                                                ...
                                                <td id="row_order_date" class="order_date column-order_date c_order_date"><?php echo $transaction_date ?></td>
                                                <td id="row_order_status" class="order_status column-order_status1 c_order_status" data-colname="Status"><span class="order-status <?php echo strtolower($status_color_code) ?>"><strong><?php echo ucfirst($order_status); ?></strong></span></td>
                                                <td id="row_order_total" class="order_total column-order_status c_order_total">₹<?php echo $order_amount ?></td>
                        ...
                        if (!empty($all_order_data['total_items'])) {
                            ...
                            <div class="tablenav bottom">
                                <div class="tablenav-pages order-lst-tp">
                                    <span class="displaying-num">Total <?php echo $all_order_data['total_items']; ?> items</span>
