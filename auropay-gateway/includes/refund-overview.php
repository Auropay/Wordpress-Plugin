...
<div>
	<div class="before-refund">
		...
		<table style="border-top: 1px solid #999; margin-top:12px; padding-top:12px">
			...
			<tbody>
				<tr>
					<button type="button" class="button button-primary do-api-refund" onclick="return arp_refund_btn()">Refund</button>
				</tr>
			</tbody>
		</table>
	</div>
